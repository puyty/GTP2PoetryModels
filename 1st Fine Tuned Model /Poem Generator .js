from transformers var GPT2LMHeadModel, = require('GPT2LMHeadModel,');

function generate_poem(first_line) {
    modelete = GPT2LMHeadModel.from_pretrained('/users/sean/Downloads/gmodel1_finetuned');
    ...
    while (len(poem) < max_lines) {
        ...
        while (words && len(poem) < max_lines) {
